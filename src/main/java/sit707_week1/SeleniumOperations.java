...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\chrome drive\\chromedriver-win64/chromedriver.exe");
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from s223711461, SAI PRIYAMVADA.K");
